...
var theme = function () {
    ...
    return {
        ...
        initCountDown: function () {
            var austDay = new Date(2016, 3, 19, 19);
        ...
        initGoogleMap: function() {
            ...
            function initialize() {
                var mapOptions = {
                    scrollwheel: false,
                    zoom: 12,
                    center: new google.maps.LatLng(19.402802, -99.1730517) // map coordinates
                };
                map = new google.maps.Map(document.getElementById('map-canvas'),
                    mapOptions);
                marker = new google.maps.Marker({
                    position: new google.maps.LatLng(19.4028608,-99.1709455), // marker coordinates
                    map: map,
                    title: 'Lugar'
                });
            }
